...
D22_quick.append_initialize("  if(!strcmp(\"none\", Vin_filename) || stage<=0) Vin_filename[0]='\0'; ")
...
D22_Detector = D22_quick.add_component("D22_Detector", "Monitor_nD")
D22_Detector.xwidth = 0.98
D22_Detector.yheight = 1.024
D22_Detector.options = "\"x bins=128 y bins=256\""
D22_Detector.append_EXTEND("ABSORB; ")
D22_Detector.set_AT(['0', '0', 'D22_collimation'], RELATIVE="D22_Sample_Pos")
